...
| CUDA | Supported through selected ComfyUI environment | PASS | NVIDIA A40 exact-artifact stress, OOM, recovery, cancellation, tiling, FP16, exact cleanup, and release-workload 100-job pixel-exact soak; Gates 10/12 |
