  ...
  return (
    <div className="asset-backdrop">
      <section className="asset-panel setup-panel glass-card" aria-label="Model and output setup">
        ...
        <label className="number-field setup-prefix"><span>Output filename prefix</span><input className="text-input" maxLength={128} value={settings.runtime.filenamePrefix} onChange={(event) => onSettings({ ...settings, runtime: { ...settings.runtime, filenamePrefix: event.target.value } })} /><small>1–128 characters; cannot contain /, \\, or a null character.</small></label>
